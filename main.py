...
def check_flights():
    try:
        ...
        for row in rows:
            ...
            if len(cols) >= 4:
                flight_info = {
                    "number": cols if len(cols) > 0 else "غير محدد",   
                    "origin": cols if len(cols) > 1 else "غير محدد",   
                    "time": cols if len(cols) > 2 else "غير محدد",     
                    "status": cols if len(cols) > 3 else "غير محدد",   
                    "airline": cols if len(cols) > 4 else "غير محدد"  
                }
